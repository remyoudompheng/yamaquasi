...
brunch::benches! {
    ...
    isqrt),
    {
        let prime160 = U512::from_dec_str("1267700734046967910160193878489299434564357851243").unwrap();
        Bench::new("inv_mod(3, 160-bit prime) = Some(...)")
        .with_timeout(Duration::from_secs(1))
        .run_seeded(3,
                    |k: u64| inv_mod(U512::from(k), prime160))
    },
    ...
    {
        let prime160 = U512::from_dec_str("1267700734046967910160193878489299434564357851243").unwrap();
        Bench::new("sqrt_mod(3, 160-bit prime) = Some(...)")
        .with_timeout(Duration::from_secs(1))
        .run_seeded(3,
                    |k: u64| sqrt_mod(U512::from(k), prime160))
    },
}
